...
class Boldgrid_Theme_Grep {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Boldgrid_Theme_Grep_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'BOLDGRID_THEME_GREP_VERSION' ) ) {
			$this->version = BOLDGRID_THEME_GREP_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'boldgrid-theme-grep';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-boldgrid-theme-grep-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-boldgrid-theme-grep-i18n.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Boldgrid_Theme_Grep_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Boldgrid_Theme_Grep_Loader    Orchestrates the hooks of the plugin.
	 */
